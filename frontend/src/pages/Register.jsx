...
const Register = () => {
  ...
  const Field = ({ label, type = 'text', value, onChange, placeholder, autoComplete, pattern, minLength }) => (
    <div>
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Field label="Phone Number"  type="tel"  value={phone} onChange={(e) => setPhone(e.target.value)}
          placeholder="10-digit mobile number" autoComplete="tel" pattern="^[+]?[0-9]{10,15}$" />
